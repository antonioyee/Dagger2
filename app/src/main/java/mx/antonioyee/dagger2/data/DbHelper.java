package mx.antonioyee.dagger2.data;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String USER_COLOMN_USER_UPDATED_AT = "updated_at";
    ...
    private void tableCreateStatements(SQLiteDatabase db) {
        try {
            db.execSQL(
                    ...
                    + USER_COLOMN_USER_UPDATED_AT + " VARCHAR(10) DEFAULT " + getCurrentTimeStamp() + ")"
            );
    ...
    protected User getUser(Long userId) throws Resources.NotFoundException, NullPointerException {
        ...
        try {
            ...
            if ( cursor.getCount() > 0 ) {
                ...
                user.setUpdateAt(cursor.getString(cursor.getColumnIndex(USER_COLOMN_USER_UPDATED_AT)));

                return user;
            }else{
                throw new Resources.NotFoundException("User with id " + userId + " does not exits");
            }
